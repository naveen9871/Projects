...
class greet_Capabilities(Action):

    def name(self) -> Text:
        return "action_greet_capabilities"
...
class greet_how(Action):

    def name(self) -> Text:
        return "action_greet_how_are_you"
...
class greet_who(Action):

    def name(self) -> Text:
        return "action_greet_who_are_you"
...
class greet_weather_city(Action):

    def name(self) -> Text:
        return "action_greet_weather_in_city"
    
    def run(self,dispatcher, tracker, domain):
        intent =  tracker.latest_message['intent'].get('name')
        dispatcher.utter_message(intent)

class greet_weather_withoutcity(Action):

    def name(self) -> Text:
        return "action_greet_weather_without_city"
...
class Smalltalk_human(Action):

    def name(self) -> Text:
        return "action_smalltalk_human"
...
class Send_sample_text(Action):

    def name(self) -> Text:
        return "action_send_sample_text"
...
class Send_sample_image(Action):

    def name(self) -> Text:
        return "action_send_sample_image"
